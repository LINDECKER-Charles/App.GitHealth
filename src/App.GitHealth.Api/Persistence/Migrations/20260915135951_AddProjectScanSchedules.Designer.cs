...
namespace App.GitHealth.Api.Persistence.Migrations
{
    ...
    [Migration("20260915135951_AddProjectScanSchedules")]
    partial class AddProjectScanSchedules
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("App.GitHealth.Api.Persistence.Entities.ContributorSnapshotEntity", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("App.GitHealth.Api.Persistence.Entities.ProjectEntity", b =>
                {
                    ...
                    b.Property<long?>("ScheduleChangedAtUtc")
                        .HasColumnType("INTEGER");
                    ...
                    b.Property<long?>("ScheduleLastRunAtUtc")
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("App.GitHealth.Api.Persistence.Entities.ContributorSnapshotEntity", b =>
                {
                    b.HasOne("App.GitHealth.Api.Persistence.Entities.BranchSnapshotEntity", "BranchSnapshot")
